  ...
  return (
    <Layout>
      <div className="fade-in">
        <h1 style={{ fontSize: '2rem', marginBottom: '1rem' }}>Doctor Profile</h1>
        ...
        <div className="card">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              {form.profileImage ? (
                <img src={form.profileImage} alt="Doctor" style={{ width: 72, height: 72, borderRadius: '50%', objectFit: 'cover' }} />
              ) : (
                <div style={{
                  width: 72,
                  height: 72,
              ...
              <div>
                <div style={{ fontSize: '1.2rem', fontWeight: 700 }}>{form.name || 'Doctor'}</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '0.75rem' }}>
            ...
            <div className="input-group">
              ...
              <input className="input" disabled={!editing} value={form.specialization || ''} onChange={(e) => setField('specialization', e.target.value)} />
            </div>
          ...
          {!editing && (
            <div style={{ marginTop: '0.75rem', color: 'var(--text-secondary)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <UserCheck size={16} />
              Profile data syncs with your doctor account in real time.
            </div>
          )}
        </div>
      </div>
